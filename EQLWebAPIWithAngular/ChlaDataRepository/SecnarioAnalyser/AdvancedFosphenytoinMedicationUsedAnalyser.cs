        ...
        protected override JObject AnalyseAction(JObject jsonObject)
        {
            ...
            if (jarr != null)
            {
                ...
                foreach (var jobj in jarr)
                {
                    ...
                    else if (currentrow.GetValue("Action")?.ToString() == "MEDICATION_USED" && currentrow.GetValue("ActionValue")?.ToString() == "FosphenytoinIVMedication" && currentrow.GetValue("ActionOutcome")?.ToString() == "ACTIVATED")
                    {
