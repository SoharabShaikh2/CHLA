...
{
    class MedicationsS1QualitativeAnalyser : Analyser
    {
    ...
    class MedicationsS2QualitativeAnalyser : Analyser
    {
        protected override JObject AnalyseAction(JObject jsonObject)
        {
            string ErrorType = null;
    ...
    class MedicationsS4QualitativeAnalyser : Analyser
    {
        protected override JObject AnalyseAction(JObject jsonObject)
        {
            string ErrorType = null;
            ...
            if (jarr != null)
            {
                ...
                else if (mainMedUsed != null && medUsed != null && medUsed2 != null && secn2 != null)
                {
